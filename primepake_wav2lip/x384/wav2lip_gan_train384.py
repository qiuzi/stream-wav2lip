...
from trains import Wav2lip_Dataset, wganGP_train, load_checkpoint
...
if __name__ == "__main__":
    ...
    # Train!
    wganGP_train(args.device, model, train_data_loader, test_data_loader, optimizer, disc_optimizer, checkpoint_dir,
              syncnet, disc,
